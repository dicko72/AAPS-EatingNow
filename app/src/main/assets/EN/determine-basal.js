...
var determine_basal = function determine_basal(glucose_status, currenttemp, iob_data, profile, autosens_data, meal_data, tempBasalFunctions, microBolusAllowed, reservoir_data, currentTime, isSaveCgmSource) {
    ...
    */
    ...
    var ENWIOBThreshU = profile.current_basal * profile.ENWIOBTrigger/60, ENWTriggerOK = (ENactive && ENWIOBThreshU > 0 && (iob_data.iob > ENWIOBThreshU || lastBolusAge < 10));
...
//    enlog +="TDD24H:"+round(tdd24h,3)+", TDD7D:"+round(tdd7d,3)+", TDDPUMPNOWMS:"+round(tdd_pump_now_ms,3)+" = TDD:"+round(TDD,3)+"\n";
    ...
    } else if (meal_data.TIRW2 < meal_data.TIRW1 && meal_data.TIRW2L > meal_data.TIRW1L) {
        TIR_sens = -1;
        ins_val = target_bg;
...
//    enlog += "*** TESTING FUTURE DELTA ***\n";
    ...
    rT.reason += (!ENWTriggerOK && ENWIOBThreshU > 0 ? " IOB&lt" + round(ENWIOBThreshU,2) : "");
    ...
    if (iob_data.iob > max_iob) {
        ...
        var insulinReqOrig = insulinReq, minPredBGweight = (sens_predType = "COB" ? 0.70 : 0.70);
