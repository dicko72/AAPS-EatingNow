...
//**********************************************************************************************************************************************
        ...
        this.profile.put("EN_Use_LargerENWSMB", sp.getBoolean(R.string.key_use_enw_iob_smb, false))
...
//**********************************************************************************************************************************************
        ...
        if (resistancePerHr > 0) {
            var TIRStart = ENWStartTime + (ENWDuration * 60000) + (45 * 60000) // TIRS starts 45m after eating window finishes
            val TIRDuration = 2.0
