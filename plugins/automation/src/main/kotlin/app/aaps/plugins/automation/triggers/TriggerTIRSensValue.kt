...
class TriggerTIRSensValue(injector: HasAndroidInjector) : Trigger(injector) {
    ...
    private constructor(injector: HasAndroidInjector, triggerAutosensValue: TriggerTIRSensValue) : this(injector) {
    ...
    override fun duplicate(): Trigger = TriggerTIRSensValue(injector, this)
