...
class TranslatorImpl @Inject internal constructor(
    ...
    override fun translate(units: ValueWithUnit?): String = when (units) {
        ...
        is ValueWithUnit.Minute      -> rh.gs(R.string.shortminute)
    ...
    override fun translate(type: TherapyEvent.Type?): String = when (type) {
        ...
        TherapyEvent.Type.CORRECTION_BOLUS        -> rh.gs(R.string.careportal_correctionbolus)
        TherapyEvent.Type.CARBS_CORRECTION        -> rh.gs(R.string.careportal_carbscorrection)
        TherapyEvent.Type.BOLUS_WIZARD            -> rh.gs(R.string.boluswizard)
        TherapyEvent.Type.COMBO_BOLUS             -> rh.gs(R.string.careportal_combobolus)
        TherapyEvent.Type.ANNOUNCEMENT            -> rh.gs(R.string.careportal_announcement)
 ...
 */
        TherapyEvent.Type.NONE                    -> rh.gs(R.string.unknown)
    ...
    override fun translate(reason: TemporaryTarget.Reason?): String = when (reason) {
        ...
        TemporaryTarget.Reason.EATING_NOW  -> rh.gs(R.string.eatingnow)
    ...
    override fun translate(reason: OfflineEvent.Reason?): String = when (reason) {
        ...
        OfflineEvent.Reason.OTHER           -> rh.gs(R.string.uel_other)
